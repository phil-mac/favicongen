            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 dark:text-gray-400 md:text-xl">
                  Create unique favicons for your website using our advanced AI.
                  Just enter your domain and we&apos;ll do the rest.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  We&apos;ll crawl your website to create a favicon that matches
                  your style.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Get your favicon in various sizes and formats for all devices
                  and browsers.
                </p>
              </div>
            </div>
